...
const socialLinks = [
    {
        href: 'https://github.com/juanmmartinez01',
    ...
    {
        href: 'https://www.linkedin.com/in/juan-martinez-121404186/',
        icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        href: 'https://www.instagram.com/juan_martinez607/',
        ...
        <section id="contact" className="section">
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    ...
                    Contáctenos hoy para hablar sobre las necesidades de su proyecto y comenzar a colaborar.
                    </p>
                    <div className="flex items-center gap-2 mt-auto">
                        {
                            socialLinks.map(({href, icon}, key)=>(
                                    <a key={key} href={href} target="_blank" className="w-12 h-12 grid place-items-center ring-2 ring-inset ring-zinc-50/5 rounded-lg transition-[background-color, color] hover:bg-zinc-50 hover:text-zinc-950
                ...
                <form action="https://getform.io/f/bpjnvwlb" method="POST" className="xl:pl-10 2xl:pl-20">
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className="mb-4">
                            <label htmlFor="name" className="label reveal-up">Nombre</label>
                            <input className="text-field reveal-up" type="text" name="name" id="name" autoComplete="name" placeholder="Nombre" required />
                        </div>
                        <div className="mb-4">
                            <label htmlFor="email" className="label reveal-up">Email</label>
                            <input className="text-field reveal-up" type="email" name="email" id="email" autoComplete="email" placeholder="correo@example.com" required />
                        </div>
                    </div>
                    <div className="mb-4">
                        ...
                        <textarea name="message" id="message" placeholder="Hola" className="text-field resize-y min-h-32 max-h-80 reveal-up" required></textarea>
                    </div>
